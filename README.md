...
- If `sheet_all.png` is missing, the game uses colored placeholder boxes
- Animation cycles through frames 1-11 on attack, then returns to frame 0 (idle)
